...
deleteStatement
    : DELETE FROM qualifiedName (AS? identifier)? outputClause? (USING tableSource)? whereClause?  # deleteFromUsing
...
identifier : ID | QUOTED_IDENTIFIER | USER_VAR | SETS ;
